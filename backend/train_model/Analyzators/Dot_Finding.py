...
def pose_detection(video_base_size: int, source_path: str, destination_path: str, extension: str = ".mov") -> None:
    """
    ...
    Args:
        ...
        extension (str): Расширение для видеофрагментов.
    Returns:
        None.
    """
    ...
    for i in range(video_base_size):
        ...
        source_filename = os.path.join(source_path, f"{str(i + 1)}{extension}")
